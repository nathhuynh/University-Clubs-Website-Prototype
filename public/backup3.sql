...
INSERT INTO `Users` VALUES (1,'a','a','$argon2id$v=19$m=65536,t=3,p=4$iS+iFSsUObGUdeFLq1Vt6Q$aud8oc583ah8shQrUR/893KHHwCVIBPFBJdfsGH08IE','a','no'),(2,'user','2','$argon2id$v=19$m=65536,t=3,p=4$kxx+JsxF7ZHVt5A6k+/clQ$yBEuti/jbQz3dQJtJc/vyBUHesEQryzALC0LYCrfIRo','test@test','no'),(5,'An','Nguyen','$argon2id$v=19$m=65536,t=3,p=4$jnaXvMIpLdcXW/CYiyoGbw$CNvU6k0WqU+gWgu0fLn7C4+chfqtFFEfuZcIUZSUfY4','nguyenthukyan@gmail.com','no');
...
INSERT INTO `feedback` VALUES (1,'yall suck',1),(2,'yall great',2);
...
-- Dump completed on 2023-06-07  6:42:13
